-- Manually process existing signups that have invitations but no employee records

-- Get the invitations that should have been used
DO $$
DECLARE
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO employees (
            ...
            CASE 
                WHEN invitation_rec.employee_data->>'birth_date' IS NOT NULL 
